...
_DTYPE_FIELDSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tzrpc.proto.dtype.FieldsEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='tzrpc.proto.dtype.FieldsEntry.value', index=1,
...
_DTYPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='tzrpc.proto.dtype.type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='byte_order', full_name='tzrpc.proto.dtype.byte_order', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='names', full_name='tzrpc.proto.dtype.names', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fields', full_name='tzrpc.proto.dtype.fields', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='subdtype', full_name='tzrpc.proto.dtype.subdtype', index=4,
...
_SUBDTYPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='tzrpc.proto.subdtype.type', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='shape', full_name='tzrpc.proto.subdtype.shape', index=1,
...
_NDARRAY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='shape', full_name='tzrpc.proto.ndarray.shape', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dtype', full_name='tzrpc.proto.ndarray.dtype', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data', full_name='tzrpc.proto.ndarray.data', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='strides', full_name='tzrpc.proto.ndarray.strides', index=3,
...
_NDARRAYS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ndarray', full_name='tzrpc.proto.ndarrays.ndarray', index=0,
...
ndarrays = _reflection.GeneratedProtocolMessageType('ndarrays', (_message.Message,), {
