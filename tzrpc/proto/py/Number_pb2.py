...
_INTEGER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tzrpc.proto.Integer.value', index=0,
...
_FLOAT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tzrpc.proto.Float.value', index=0,
...
_DOUBLE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tzrpc.proto.Double.value', index=0,
...
_INTEGERARRAYLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tzrpc.proto.IntegerArrayList.value', index=0,
...
_FLOATARRAYLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tzrpc.proto.FloatArrayList.value', index=0,
...
_DOUBLEARRAYLIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tzrpc.proto.DoubleArrayList.value', index=0,
...
IntegerArrayList = _reflection.GeneratedProtocolMessageType('IntegerArrayList', (_message.Message,), {
...
FloatArrayList = _reflection.GeneratedProtocolMessageType('FloatArrayList', (_message.Message,), {
...
DoubleArrayList = _reflection.GeneratedProtocolMessageType('DoubleArrayList', (_message.Message,), {
